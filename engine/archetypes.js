...
export const BODY_ARCHETYPES = Object.freeze({
  fatCat:            profile("Summoner", "Summon / Board", "summon", "aggro", "scaling"),
  royalRat:          profile("Summoner", "Summon / Board", "summon", "tempo", "scaling"),
  paidPiper:             profile("Summoner", "Summon / Board", "summon", "tempo", "scaling"),
  ...
  centlessCentaur:          profile("Caster", "Economy / Tempo", "tempo", "burst"),
  lizardWizard:          profile("Caster", "Economy / Tempo", "tempo", "cost"),
  ...
  malevolentMouse:      profile("Attacker", "Scaling / Carry", "scaling", "burst"),
  rentSeekingRuneblade:      profile("Attacker", "Scaling / Carry", "scaling"),
  interestImp:         profile("Attacker", "Scaling / Carry", "scaling", "defense"),
  ...
  tollTroll:         profile("Support", "Sustain / Fortify", "sustain"),
  vengefulVampire:           profile("Support", "Sustain / Fortify", "sustain"),
  goldenGolem:        profile("Defender", "Sustain / Fortify", "defense"),
  ...
  cryptoChimera:          profile("Attacker", "Pressure / Control", "tempo", "aoe"),
  wearyWageslave:        profile("Attacker", "Pressure / Control", "tempo"),
  ...
  marketCrashMinotaur:         profile("Attacker", "Reactive / Aggro", "aggro"),
  bondBehemoth:      profile("Attacker", "Reactive / Aggro", "aggro", "scaling"),

...
export const KIT = {
  ...
  oRainblow:   { name: "Rainblow Blade", ante: 1, cost: 3, icon: "🌈", color: "#c07fe8", text: "Strike the front foe for your melee + ranged bonuses; 6 seconds later, strike your whole lane the same way.",
  ...
  oGiantsBelt: { name: "Giant's Belt", ante: 1, cost: 5, lasting: true, icon: "🥋", color: "#a0b070", text: "This fight: your max health grows by your base health (once) and you heal the gained amount.", ops: [{ do: "giantBelt" }] }, // FLAGGED: cost 5 picked; duration read as THIS FIGHT (owner said "passive" — worn passives are dead per his own 7/06 ruling, so it's a lasting cast like Stoneskin). NERF (owner 2026-07-10): +base health ONCE, non-compounding (was framed as a "double"); magnitude FLAGGED in applyGiantBelt.

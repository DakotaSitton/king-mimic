...
| Stockbroking Sphinx | Every 12 seconds, choose an available option: ally-target healing or target damage for 12 plus ranged bonus, or gain up to 12 moxie, including 2 spendable moxie above the normal cap. A used option stays locked until all three have been chosen. | Every used option makes the next choice 1 second faster, down to 6 seconds. | Every option gains +2 effect/rank. |

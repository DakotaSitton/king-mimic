...
// --- barrel: level/room world building now lives in engine/world.js ---
export * from "./engine/world.js";
import {
  LEVEL_HP_PER_EVEN, LEVEL_COMBAT_PER_ODD, LEVEL_ANTE_PER, FOE_LEVEL_MIN,
  foeLevel, levelHpBonus, levelCombatBonus, levelAnte, foeMaxHpFor,
  bodyAnteOf, itemsAnteOf, anteOfFoe, foeLootValue, anteCurrent, bodyValue, roomValue,
  SHOP_WARES, shopPrice, rollShopWares, GIMMICKS, buildLevel, stockLevelRooms,
  nodeById, currentNode, enterRoom, descend,
...
// --- barrel: the combat engine now lives in engine/combat.js ---
export * from "./engine/combat.js";
import {
  ATLAS_REFLECT_HIT, ATLAS_REFLECT_PER, ECHO_CD, ECHO_DELAY, FOE_DMG_OPS, PASSIVE_BAR_COLOR, RAT_KEYS, absorbShield,
  accelClocks, addBuff, aimedFoe, applyCombatStart, armEcho, atlasReflect, autoPlay, bodyTags,
  buffAmt, cardEventPassives, cycleTarget, damageEnemy, damagePlayer, dealtTriggerPassives, drainClocks, echoDelay,
  effAtk, effMag, effPhys, effectiveDamageTo, ensureTarget, fireSchoolTrigger, foeCardCost, foeCast,
  foeCount, foeDealHit, foeHitFront2, foeHitLane, foeHitLaneAll, foeHitRanged, foeItemDmg, foeOpsDmg,
  foeThreat, foeThreats, gainTriggerPassives, hasBuff, heroesInLane, hitTriggerPassives, itemDmgReduce, itemStatBonus,
  laneAura, laneHeroes, laneLine, lowestEHpPlayer, moveDepth, nearestDefendedLane, opsHarm, playCard,
  playTriggerPassives, powerFor, resolveOps, runPassive, setAllyTarget, setTarget, simulateTick, spendTriggerPassives,
  summonBodies, syncRatStack, targetedFoe, tickBloodToIron, tickBuffs, tickDjinnCounter, tickEchoBar, tickOwnTimers,
  tickPoison, tickRegens, tickTimers, useItem,
} from "./engine/combat.js";

// --- barrel: client snapshot projection now lives in engine/snapshot.js ---
export * from "./engine/snapshot.js";
import {
  cardDescriptor, entityEffects, foeTelegraph, publicBodies, snapshot,
